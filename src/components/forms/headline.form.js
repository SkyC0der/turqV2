...
const HeadlineForm = (props) => {
  ...
  return (
    <div hidden={props.value !== props.index} className="headlineForm">
      <Typography variant="h3">Write a headline for your issue post</Typography>
      <TextField
        variant="outlined"
        value={headline}
      ...
      <Typography variant="body1">
        We'll match you with authors that will get your problem solved and
        turned into legislation right away!
      </Typography>
      <Typography variant="h4">Example titles</Typography>
      ...
      <Button onClick={moveToHome} classes={{ root: "homeButton" }}>
        Skip to home
      </Button>
      <Button
        onClick={moveToNextTab}
        classes={{ root: "nextButton" }}
        disabled={headline === ""}
      >
        Next
      </Button>
